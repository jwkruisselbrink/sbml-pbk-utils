...
To install a specific version, use the version tag. For instance, for version `v0.29.0`, use:

````
pip install git+https://github.com/jwkruisselbrink/sbml-pbk-utils.git@v0.29.0
````
